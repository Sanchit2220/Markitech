...
const data = [
  ...
  { place: 'Switzerland Alps', title: 'SAINT', title2: 'ANTONIEN', description: 'Tucked away in the Switzerland Alps, Saint Antönien offers an idyllic retreat...', image: Seo1 },

  { place: 'French Riviera', title: 'COTE', title2: "D'AZUR", description: 'The French Riviera is known for its stunning coastlines and vibrant culture...', image: Seo2 },
