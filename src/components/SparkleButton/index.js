  ...
  return (
    ...
    <SparkleButtonWrapper>
      ...
      <span aria-hidden="true" className="particle-pen">
        ...
        {/* Repeat the particle SVGs if needed */}
...
const Button = styled.button`
  ...
  box-shadow: 0 0 calc(var(--active) * 6em) calc(var(--active) * 3em) hsl(260 97% 61% / 0.75), 0 0.05em 0 0 hsl(260 calc(var(--active) * 97%) calc((var(--active) * 50%) + 30%)) inset, 0 -0.05em 0 0 hsl(260 calc(var(--active) * 97%) calc(var(--active) * 60%)) inset;
